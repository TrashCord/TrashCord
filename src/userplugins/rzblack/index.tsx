...
const UserContext: NavContextMenuPatchCallback = (children, { user }) => {
    ...
    children.splice(-1, 0, (
        <Menu.MenuGroup>
            <Menu.MenuItem
                id="vc-blacklist"
                label={blacklisted ? "Remove Blacklist" : "Add to Blacklist"}
...
const ChannelContext: NavContextMenuPatchCallback = (children, { channel }) => {
    ...
    items.push(
        <Menu.MenuItem
            ...
            action={() => {
                Alerts.show({
                    title: "Remove All",
                    body: `Do you want to remove all ${list.length} from your blacklist?`,
    ...
    children.splice(-1, 0, (
        <Menu.MenuGroup>
            <Menu.MenuItem id="vc-bl-list" label="Remove Blacklist">
                {items}
            </Menu.MenuItem>
        </Menu.MenuGroup>
    ));
