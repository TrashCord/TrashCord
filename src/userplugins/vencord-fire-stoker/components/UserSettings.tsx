...
function ServerSelectorModal({ modalProps, currentList, onUpdate }: { modalProps: ModalProps; currentList: string[]; onUpdate: (serverIds: string[]) => void; }) {
    ...
    return (
        <ModalRoot {...modalProps} size={ModalSize.MEDIUM} className={cl("root") + " firestoker-modal-root"}>
            <ModalHeader className={cl("head")}>
                <Text variant="heading-lg/semibold">Select Servers</Text>
                <ModalCloseButton onClick={modalProps.onClose} />
            </ModalHeader>
            <ModalContent className={cl("contents") + " firestoker-modal-contents"} style={{ padding: "16px" }}>
                ...
                <input
                    ...
                    className="firestoker-server-search-input"
                />
                            ...
                            filteredGuilds.map(guild => {
                                ...
                                return (
                                    <div
                                        ...
                                        className={`firestoker-server-item ${isSelected ? "selected" : ""}`}
                                    >
                                        <div style={{
                                            width: "20px",
                                            height: "20px",
                                        ...
                                        <Text
                                            ...
                                            className="firestoker-server-item-name"
...
export function UserStalkerSettingsModal({ modalProps, userId, userStore }: { modalProps: ModalProps; userId: string; userStore: any; }) {
    ...
    return (
        <ModalRoot {...modalProps} size={ModalSize.MEDIUM} className={cl("root") + " firestoker-modal-root"}>
            ...
            <ModalContent className={cl("contents") + " firestoker-modal-contents"} style={{ padding: "16px", display: "flex", flexDirection: "column", gap: "16px" }}>
                <div>
                            ...
                            <div style={{ marginTop: "8px", paddingTop: "8px", borderTop: "1px solid var(--background-modifier-accent)" }}>
                                <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "4px" }}>
                                    ...
                                    <input
                                        ...
                                        className="firestoker-number-input"
                                        style={{
                                            width: "60px",
                                            padding: "4px 8px",
